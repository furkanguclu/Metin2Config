...
namespace config
{
    public partial class config : Form
    {
        ...
        private void ConfigurationWriter()
        {
            ...
            {
                MessageBox.Show("Yapılandırma dosyası oluşturulamıyor, programı yönetici olarak başlatmayı deneyin : {0}", e.ToString());
                Application.Exit();
            }
        }
    ...
    internal class STATICS
    {
        ...
        public static Dictionary<string, List<string>> configDict = new Dictionary<string, List<string>>()
        {
            ...
            {"MUSIC_VOLUME", new List<string>(){"0.000", "1.000"}}, // Min & Max
            {"VOICE_VOLUME", new List<string>(){ "0.000", "1.000", "2.000", "3.000", "4.000", "5.000"}}, // Min & Max
